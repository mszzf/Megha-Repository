...
MyMap.prototype = {
	...
	*/
	...
	soap: function (containerId, functionName) {
        var that = this;
       // var url = "http://localhost:19832/WebService.asmx";
	   var url ="http://localhost:7286/WebService.asmx";
	   this.soapMethod = functionName;
        this.soapRefresh(false, true);
   ...
   soapRefresh: function (load, displayResult) {
        delete this.pl['name'];
        delete this.pl['age'];
        delete this.pl['company'];
        delete this.pl['position'];
        ...
        case "InsertTable":
            this.pl.add("name", document.getElementById("nameInsert").value);
            this.pl.add("age", document.getElementById("ageInsert").value);
            this.pl.add("company", document.getElementById("company").value);
            this.pl.add("position", document.getElementById("position").value);
            break;
        case "DeleteTable":
            this.pl.add("name", document.getElementById("nameDelete").value);
            break;
...
var FourSquare = function () {
    ...
    this.clientId = 'QSQI4BKJRGKV0NPDNBNAECRP0U3YKX2KMZIY01HZYDIKVSST';
    this.clientSecret = 'BUQC5DBCRYTQPR3KHFOLNMHPE1Z2MYD0BW4Z1CO1V2NFK21S';
    //this.redirectUri = 'https://php2.umkc.edu/SCE/e-save/demo/assets/html/homepage.html';
	this.redirectUri = 'http://192.168.56.1/html/myTravels.html';
	this.ll='';
...
FourSquare.prototype = {
	...
	explore: function () {
		...
		var url1 = 'https://api.foursquare.com/v2/venues/explore?near=' + this.near; 
		...
		$.ajax({
            ...
            success: function (data) {
				...
				var group=obj.response.groups[i];
				ids.push(obj.statuses[i].id); */
				}
